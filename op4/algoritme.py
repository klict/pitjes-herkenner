...
# -----------------------------------------------
from utils import dominant_color_in_square, color_in_range, get_frame_from_image, find_and_draw_contour
...
for key_point in key_points:
    ...
    frame = get_frame_from_image(resized_img, x, y, size)
    color = black
    ...
    resized_img = find_and_draw_contour(resized_img, x, y, size, color)
